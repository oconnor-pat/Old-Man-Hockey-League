...
function Homefeed() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(Navbar, {}), _jsx(StyledNewPostButton, { onClick: handleNewPostButtonClick, children: "New Post" }), _jsxs(StyledContainer, { children: [_jsxs(StyledHomefeed, { children: [_jsx(StyledTitle, { children: "Homefeed" }), userPosts.map((post) => (_jsxs(StyledPostBox, { focused: editingPost?.id === post.id, onClick: () => handlePostClick(post.id), children: [_jsx("h4", { children: "Username" }), editingPost?.id === post.id ? (
